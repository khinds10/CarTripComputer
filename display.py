...
while True:
    try:
        ...
        subprocess.call(["/home/pi/CarTripComputer/digole", "printxy_abs", "10", "178", summary])
        subprocess.call(["/home/pi/CarTripComputer/digole", "setFont", "51"])
        subprocess.call(["/home/pi/CarTripComputer/digole", "printxy_abs", "150", "40", date.strftime('%a, %b %d')])
        ...
        if dt.datetime.now().hour > 16 or dt.datetime.now().hour < 6:
            subprocess.call(["/home/pi/CarTripComputer/digole", "setColor", "223"])
            subprocess.call(["/home/pi/CarTripComputer/digole", "printxy_abs", "150", "130", "LOW\n" + apparentTemperatureMin + '*F'])
        else:
            subprocess.call(["/home/pi/CarTripComputer/digole", "setColor", "222"])
            subprocess.call(["/home/pi/CarTripComputer/digole", "printxy_abs", "150", "130", "HIGH\n" + apparentTemperatureMax + '*F'])
        
        # show indoor / outdoor temp
        subprocess.call(["/home/pi/CarTripComputer/digole", "setFont", "120"])
        
        subprocess.call(["/home/pi/CarTripComputer/digole", "setColor", "255"])
        subprocess.call(["/home/pi/CarTripComputer/digole", "printxy_abs", "150", "85", apparentTemperature + "*F [" + humidity + "%]"])
        
        subprocess.call(["/home/pi/CarTripComputer/digole", "setColor", "250"])
        subprocess.call(["/home/pi/CarTripComputer/digole", "printxy_abs", "70", "230", "IN: " + str(insideTemperature) + "* F [" + str(insideHumidity) + " %]"])
